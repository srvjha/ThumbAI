    ...
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center">
          ...
          <p className="text-base text-neutral-400 mb-8 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-12 bg-neutral-900 text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {/* Thumbnail 1 */}
            <div className="rounded-xl overflow-hidden shadow-lg bg-neutral-800">
              <img
                src="https://v3.fal.media/files/monkey/k7UkT9KYfcgcmk09Clx1j.jpeg"
                alt="Thumbnail 1"
            ...
            {/* Thumbnail 2 */}
            <div className="rounded-xl overflow-hidden shadow-lg bg-neutral-900">
              <img
                src="/pgmarry.jpeg"
                alt="Thumbnail 2"
                className="w-full h-full object-cover"
            ...
            <div className="rounded-xl overflow-hidden shadow-lg bg-neutral-900">
              <img
                src="https://v3.fal.media/files/lion/mRZhoIU82yIMNCvIuOtgf.jpeg"
                alt="Thumbnail 4"
                className="w-full h-full object-cover"
              />
            </div>
