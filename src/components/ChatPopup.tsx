...
import { X, MessageCircle, Minimize2, Maximize2, RefreshCcw, Copy } from 'lucide-react';
...
import { PromptInput, PromptInputSubmit, PromptInputTextarea, PromptInputToolbar } from './ai-elements/prompt-input';
  ...
  return (
    ...
    >
      <div className="bg-neutral-950 border border-neutral-700 rounded-lg shadow-2xl h-full flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-3 border-b border-neutral-700 bg-neutral-900/40 rounded-t-lg cursor-move">
          ...
          <div className="flex flex-col h-full">
            ...
            {messages.length === 0 && (
              <div className="flex p-4 justify-center items-center text-center text-sm text-gray-400">
                Great! I've generated your images. What modifications would you like to make?
              </div>
            )}
...
export const ChatToggleButton: React.FC<ChatToggleButtonProps> = ({ onClick, hasMessages, isGenerating }) => (
